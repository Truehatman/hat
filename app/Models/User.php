...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $hidden = [
        'code', 'password', 'remember_token', 'totp_secret', 'referrer_id', 'referrer', 'notes'
    ];
    ...
    protected $appends = [
        'display_name', 'avatar_url', 'gravatar_url', 'affiliate_url', 'created_ago', 'last_seen_ago', 'role_title', 'status_title'
    ];
    ...
    public function getDisplayNameAttribute(): string
    {
        ...
        return $name->length() < 26 ? $this->name : $name->substr(0, 4) . '...' . $name->substr(-4);
    }
