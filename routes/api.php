...
Route::prefix('admin')
    ->middleware(['cookies', 'user', 'role:' . User::ROLE_ADMIN, 'permissions'])
    ->group(function () {
        ...
        Route::post('maintenance/queues/worker/restart', [MaintenanceController::class, 'restartQueueWorker'])->name('admin.maintenance.worker.restart');
        Route::post('maintenance/queues/supervisor/status', [MaintenanceController::class, 'getSupervisorServiceStatus'])->name('admin.maintenance.supervisor.status');
        Route::post('maintenance/cron/jobs', [MaintenanceController::class, 'getCronJobs'])->name('admin.maintenance.cron.jobs');
